...
const photos = [];
export default function PhotosUploader({ picture, onChange }) {
  ...
  function removePhoto(ev, filename) {
    ev.preventDefault();
    onChange([...picture.filter((photo) => photo !== filename)]);
  }

  function selectAsMainPhoto(ev, filename) {
    ev.preventDefault();
    onChange([filename, ...picture.filter((photo) => photo !== filename)]);
  }
