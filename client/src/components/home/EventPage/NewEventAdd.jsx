...
const AddNewEvent = () => {
    ...
    return (
        <div className="bg-white  md:w-2/4 m-auto  h-32  border-double border-4 border-slate-700 mt-4 rounded-lg overflow-hidden ">
            <div className=" flex items-center justify-center h-1/2 drop-shadow-lg">
                <img src="./logo.jpg" alt="" className="max-w-1/5 h-10 mx-4 rounded-full" />
